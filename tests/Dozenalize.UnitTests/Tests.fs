...
let tests =
    testList "Tests" [
        testList "For number to dozenal string conversion" [
            ...
            test "double: 0.999999 (precision 5)" {
                let result = displayPrecision 5 0.999999
                // Should round up
                Expect.equal result "1.00000" "The strings should equal"
            }
        ...
        testList "properties for conversion back and forth" [
