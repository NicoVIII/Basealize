...
type NiftimalPrinter(precision) =
    new() = NiftimalPrinter(3uy)
    ...
    static member Create(precision) =
        NiftimalPrinter(precision) :> BasePrinter

    static member Create() = NiftimalPrinter() :> BasePrinter
...
type NiftimalParser() =
    ...
    static member Create() = NiftimalParser() :> BaseParser
